...
def test_reply_callback_hooks_cover_pipeline_and_realtime_paths() -> None:
    ...
    # realtime path emits once per turn with all created assistant messages
    assert "self._emit_reply_callback(self._agent._chat_ctx, reply_messages)" in realtime_source
